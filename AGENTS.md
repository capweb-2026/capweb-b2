...
Vélix est un chatbot en JavaScript natif, sans framework, spécialisé dans la réparation et l'entretien de vélo. Il répond avec un cerveau à règles et, à partir de mercredi, avec une IA appelée par le serveur.
...
- `public/js/persona.js` : identité de Vélix, message d'accueil et trois suggestions ;
...
- Ne jamais inventer un diagnostic mécanique présenté comme certain sans information suffisante.
- Ne jamais conseiller une réparation présentant un risque important pour la sécurité sans recommander de faire vérifier le vélo par un professionnel.
- Ne jamais afficher plus de trois suggestions de questions.
- Ne jamais modifier l'identité de Vélix sans validation de l'humain.
